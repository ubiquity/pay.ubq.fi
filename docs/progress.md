...
*   **Phase 7: Documentation & Deployment**: IN PROGRESS (Docs update, Frontend deployment script created). Backend deployment TBD.
...
*   **Deployment Script**: Created `scripts/deploy-frontend.sh` for automated build and deployment to Deno Deploy using `deployctl`.
