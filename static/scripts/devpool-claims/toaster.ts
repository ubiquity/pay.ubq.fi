...
const removeToast = (toast: HTMLElement, timeoutId?: NodeJS.Timeout) => {
...
export const createToast = (icon: keyof typeof toastIcons, text: string) => {
...
export const disableClaimButton = (triggerLoader = true) => {
...
export const enableClaimButton = () => {
...
export const ErrorHandler = (error: any, errorMessage?: string) => {
  delete error.stack;
