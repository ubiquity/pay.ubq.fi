...
import { buttonController, getClaimCardButton, getMakeClaimButton, openCardContainer, viewClaimButton } from "../button-controller";
...
const table = document.getElementsByClassName("receipt")[0];
