					...
					<div className="permits-list">
						<div className="permits-body">
							{sortedPermits.map((permit) => {
								const githubUsername = permit.beneficiaryUserId
									? githubUsernames.get(permit.beneficiaryUserId)
									: undefined;
								const invalidatingThis = Boolean(
									isInvalidating[permit.signature],
								);
								return (
									<PermitRow
