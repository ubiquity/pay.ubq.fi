...
export function RewardPreferenceSelector({
	chainId,
	onPreferenceChange,
}: RewardPreferenceSelectorProps) {
	...
	return (
		...
		<div className="reward-preference-selector">
			...
			<select
				...
				title={
					isDisabled
						? "No supported reward tokens found for this network"
						: "Select your preferred token for receiving rewards (or claim original)"
				}
			>
