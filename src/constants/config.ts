...
export const COWSWAP_PARTNER_FEE_RECIPIENT: Address =
...
const location =
	typeof self !== "undefined"
		? (self as unknown as { location?: { hostname?: string; origin?: string } })
				.location
		: undefined;
const hostname =
	typeof location?.hostname === "string" ? location.hostname.toLowerCase() : "";
const origin = typeof location?.origin === "string" ? location.origin : "";

export const RPC_URL =
	hostname === "ubq.fi" || hostname.endsWith(".ubq.fi")
		? origin
			? `${origin}/rpc`
			: publicRpcUrl
		: publicRpcUrl;
...
export const OLD_PERMIT2_ADDRESS: Address =
	"0x000000000022D473030F116dDEE9F6B43aC78BA3";
export const NEW_PERMIT2_ADDRESS: Address =
	"0xd635918A75356D133d5840eE5c9ED070302C9C60";
 ...
 */
export const PERMIT_AGGREGATOR_ADDRESS: Address =
